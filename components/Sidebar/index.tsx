              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <Link
                    href="/post-offices"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('post-offices') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
                      className="fill-current"
                ...
                {/* <!-- Menu Item Forms --> */}
                <SidebarLinkGroup activeCondition={pathname === '/order' || pathname.includes('forms')}>
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <Link
                            ...
                            <li>
                              <Link
                                ...
                                className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === '/order/single-form' && 'text-white'
                                }`}
                              >
                                Single Order
                              </Link>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <Link
                    href="/employee/order"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('/employee/order') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  <Link
                    href="/employee/assigned-order"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('/employee/assigned-order') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
                      className="fill-current"
