...
const SignupComponent: FC<SignUpFormRequest> = ({ email, password, retypePassword, fullName }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      const response = await actionSubmitSignup(values);
      ...
      params.set('id', responseBody.id.toString());
      params.set('email', values.email);
      replace(`/verify?${params.toString()}`);
    },
        ...
        <div className='hidden w-full xl:block xl:w-1/2'>
          <div className='py-17.5 px-26 text-center'>
            ...
            <span className='mt-15 inline-block'>
                <Image src="/images/icon/signup.svg" alt="Data Icon" width={1500} height={1500} />
              </span>
          </div>
        </div>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className='mt-6 text-center'>
                <p>
                  ...
                  <Link href='/components/Auth/SigninComponent' className='text-primary'>
                    Sign in
                  </Link>
                </p>
              </div>
