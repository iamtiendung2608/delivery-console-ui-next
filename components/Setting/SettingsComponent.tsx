...
import { actionEditOrganization, actionEditUser } from '@/app/settings/action'
...
const SettingsComponent: React.FC<Props> = ({ user, organization }) => {
  ...
  const orgFormik = useFormik<OrganizationResponse>({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        toast.success("Edit organization success!");
      } catch {
        toast.error("Edit organization fail!");
        resetForm();
      }
    },
    validationSchema: Yup.object({
        ...
        <div className='grid grid-cols-5 gap-8'>
          ...
          <div className='col-span-5 xl:col-span-2'>
            <div
              className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
              <div className='border-b border-stroke py-4 px-7 dark:border-strokedark'>
                <h3 className='font-medium text-black dark:text-white'>Organization Information</h3>
              </div>
              <div className='p-7'>
                <form onSubmit={orgFormik.handleSubmit}>
                  <div className='mb-5.5 flex flex-col gap-5.5 sm:flex-row'>
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <select name="category"
                              value={orgFormik.values.category}
                              onChange={orgFormik.handleChange}
                              className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                  ...
                  <div className="mb-5.5">
                    <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="orgName">
                      Organization Name
                    </label>
                    <div className="relative">
                      <input
                        ...
                        name="name"
                        id="orgName"
                        placeholder="Enter your organization mail"
                        value={orgFormik.values.name}
                        onChange={orgFormik.handleChange}
                  ...
                  <div className="mb-5.5">
                    <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="Scope">
                      Scope
                    </label>
                    <select name="scope"
                            value={orgFormik.values.scope}
                            onChange={orgFormik.handleChange}
                            className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        value={orgFormik.values.description}
                        onChange={orgFormik.handleChange}
                        onBlur={orgFormik.handleBlur}
                      ></textarea>
                    </div>
