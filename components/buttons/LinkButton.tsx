...
type BaseButtonAttributes = React.ComponentPropsWithoutRef<"a">;
...
interface LinkButtonProps extends BaseButtonAttributes {
  isLoading?: boolean;
  disabled?: boolean;
...
const LinkButton = forwardRef<Ref, LinkButtonProps>( (props, ref) => {
  // destructure neccesary props
  const {href, type, children, color, size, variant, disabled, isLoading, leftIcon, rightIcon, className, ...rest} = props;
