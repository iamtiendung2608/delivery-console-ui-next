  ...
  return (
    ...
    >
      <div className='flex gap-5 items-center'>
        <Link href='/' className='bg-gray-300 p-1 w-8 h-8 text-center rounded-full text-xl hover:bg-blue-300'>
          🐕
        </Link>
      ...
      <div className='flex gap-5 items-center'>
        ...
        <Link href='https://github.com/hiroppy/nextjs-app-router-training' target='_blank'>
          <i className='text-gray-300 hover:text-blue-300'>
            <GitHubIcon />
          </i>
        </Link>
